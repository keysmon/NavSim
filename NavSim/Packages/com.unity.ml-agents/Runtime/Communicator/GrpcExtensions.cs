// NavSim: the gRPC/Protobuf training communicator is compiled only on Editor/Standalone.
// On other players (e.g. WebGL) IL2CPP cannot convert Google.Protobuf's Span methods, and
// inference-only builds never open a trainer connection, so this whole file is gated out.
