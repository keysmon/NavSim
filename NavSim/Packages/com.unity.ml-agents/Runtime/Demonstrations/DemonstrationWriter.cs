using System.IO;
// NavSim: demonstration recording serializes via Google.Protobuf, which IL2CPP cannot convert
// for WebGL. Recording is an Editor/Standalone training-time feature, so the Protobuf writes
// below are gated out on other players. The public API (and the DemonstrationRecorder that drives
// it) stays intact and simply no-ops there.
